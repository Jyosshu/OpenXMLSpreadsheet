...
namespace OpenXMLSpreadsheetNetCore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            InsertText(filepath,"Total Products Sold");
        }

        public static string userName = Environment.UserName;
        public static string filepath = $@"C:\Users\{userName}\Documents\OpenXML_SpreadsheetDemo.xlsx";
